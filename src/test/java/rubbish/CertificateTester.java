...
public class CertificateTester {
    ...
    private static final String KEY_STORE_NAME = "sso.keystore";
    private static final String CERTIFICATE_NAME = "sso.crt";
    private static final String password = "MinZhong8978570";
    private static final String alias = "sso";
    ...
    static {
        ...
        if (!currentDir.endsWith("/")) 
            currentDir += "/";
        keyStorePath = URLDecoder.decode(currentDir + KEY_STORE_NAME);
        certificatePath = URLDecoder.decode(currentDir + CERTIFICATE_NAME);
    ...
    static void testFileSign() throws Exception {
        String filePath = "D:/Base64Utils.java";
